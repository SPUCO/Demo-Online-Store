...
if(isset($_POST['admineditimagesbtn'])){
  ...
  && $imageFileType6 != "gif"){
    ...
    $productimagename1 = $productname." top.jpg";
    $productimagename2 = $productname." right.jpg";
    $productimagename3 = $productname." left.jpg";
    $productimagename4 = $productname." bottom.jpg";
    $productimagename5 = $productname." back.jpg";
    $productimagename6 = $productname." side.jpg";
    ...
    $productimagename1 = $productname." top.jpeg";
    $productimagename2 = $productname." right.jpeg";
    $productimagename3 = $productname." left.jpeg";
    $productimagename4 = $productname." bottom.jpeg";
    $productimagename5 = $productname." back.jpeg";
    $productimagename6 = $productname." side.jpeg";
    $target_file = $target_dir.$productimagename;
    $target_file1 = $target_dir.$productimagename1;
    $target_file2 = $target_dir.$productimagename2;
    $target_file3 = $target_dir.$productimagename3;
    ...
    $productimagename1 = $productname." top.png";
    $productimagename2 = $productname." right.png";
    $productimagename3 = $productname." left.png";
    $productimagename4 = $productname." bottom.png";
    $productimagename5 = $productname." back.png";
    $productimagename6 = $productname." side.png";
    $target_file = $target_dir.$productimagename;
    $target_file1 = $target_dir.$productimagename1;
    $target_file2 = $target_dir.$productimagename2;
    $target_file3 = $target_dir.$productimagename3;
    ...
    $productimagename1 = $productname." top.gif";
    $productimagename2 = $productname." right.gif";
    $productimagename3 = $productname." left.gif";
    $productimagename4 = $productname." bottom.gif";
    $productimagename5 = $productname." back.gif";
    $productimagename6 = $productname." side.gif";
    $target_file = $target_dir.$productimagename;
    $target_file1 = $target_dir.$productimagename1;
    $target_file2 = $target_dir.$productimagename2;
    $target_file3 = $target_dir.$productimagename3;
